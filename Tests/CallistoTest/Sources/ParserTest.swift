...
class CallistoTest: XCTestCase {
    ...
    func testFastlaneMobileParser() {
        guard let fastlaneOutputURL = Bundle.module.url(forResource: "ios_build_4454", withExtension: "log") else { XCTFail(); return; }
    ...
    func testFastlaneDesktopParser() {
        guard let fastlaneOutputURL = Bundle.module.url(forResource: "mac_build_4454", withExtension: "log") else { XCTFail(); return; }
        guard let fastlaneContent = try? String.init(contentsOf: fastlaneOutputURL, encoding: .utf8) else { XCTFail(); return; }
    ...
    func testIgnoreFile() {
        guard let fastlaneOutputURL = Bundle.module.url(forResource: "ios_build_4822", withExtension: "log") else { XCTFail(); return; }
        guard let fastlaneContent = try? String.init(contentsOf: fastlaneOutputURL, encoding: .utf8) else { XCTFail(); return; }
    ...
    func testXcode9_3_MobileParser() {
        guard let fastlaneOutputURL = Bundle.module.url(forResource: "ios_build_8745", withExtension: "log") else { XCTFail(); return; }
        guard let fastlaneContent = try? String.init(contentsOf: fastlaneOutputURL, encoding: .utf8) else { XCTFail(); return; }
    ...
    func testXcode9_3_DesktopParser() {
        guard let fastlaneOutputURL = Bundle.module.url(forResource: "mac_build_8745", withExtension: "log") else { XCTFail(); return; }
        guard let fastlaneContent = try? String.init(contentsOf: fastlaneOutputURL, encoding: .utf8) else { XCTFail(); return; }
